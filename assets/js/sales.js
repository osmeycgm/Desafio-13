        ...
        <div class="col-12 col-md-6 col-lg-6 mb-4 d-flex">
          <div class="card w-100">
              ...
              <div class="card-body">
                ...
                ${prop.amenities ? '<p class="text-success"><i class="fa-solid fa-table-tennis-paddle-ball"></i> Ping-pong, taca-taca, gym, quincho, etc. </p>' : '<p class="text-danger"><i class="fa-solid fa-table-tennis-paddle-ball"></i> No amenities</p>'}
              </div>
          </div>
        </div>`;
  }
